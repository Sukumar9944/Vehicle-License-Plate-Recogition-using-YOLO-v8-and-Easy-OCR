...
# Loading the model
model = YOLO(r'G:\GUVI_DATA_SCIENCE\Project\License_Plate_Recognition\custom_trained_model.pt')
...
with st.spinner(progress_text):
    try:
        if submit:
            temporary_image_path = r'G:\GUVI_DATA_SCIENCE\Project\License_Plate_Recognition\user_images'
            image.save(os.path.join(temporary_image_path, 'temp.jpg'))

            model.predict(source = r'user_images\temp.jpg', save = True, conf = 0.5, classes = 0, save_crop = True)

            bbox_image = r'G:\GUVI_DATA_SCIENCE\Project\License_Plate_Recognition\runs\detect\predict\temp.jpg'

            crop_license_image = r'G:\GUVI_DATA_SCIENCE\Project\License_Plate_Recognition\runs\detect\predict\crops\license-plate\temp.jpg'
            ...
            shutil.rmtree(r'G:\GUVI_DATA_SCIENCE\Project\License_Plate_Recognition\runs\detect\predict')
